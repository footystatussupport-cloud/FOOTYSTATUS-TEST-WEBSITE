-- Expose the existing player_profiles.date_of_birth field through the public
-- player profile view. This keeps Date of Birth on the existing player profile
-- record as the single source of truth for signup, profile viewing, player
-- editing, and Footy Status Admin editing.
