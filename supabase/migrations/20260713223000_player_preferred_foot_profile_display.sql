-- Expose the existing player_profiles.preferred_foot field through the public
-- player profile view so the Details section, public profiles, and admin tools
-- all read the same player profile source of truth.
